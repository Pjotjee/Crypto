...
class DataForecastCopy extends ArrayList<Double> {
    ...
    public DataForecastCopy(ArrayList<Double> dataLow, ArrayList<Double> dataHigh, ArrayList<Double> dataTime, ArrayList<Double> dataOpen, ArrayList<Double> dataClose) {
